...
namespace RentMe.DAL
{
	...
	public class CustomerDal : ICustomerDal
	{
        ...
        /// <returns></returns>
        [Obsolete("Use none static authenticate method instead")]
        public static int OldAuthenticate(string email, string password)
        {
            var validUser = 0;
            try
            {
        ...
        [Obsolete("Use none static register method instead")]
        public static void OldRegisterCustomer(RegisteringCustomer customer)
        {
