...
namespace RentMe.DAL
{
	...
	public class MediaDal : IMediaDal
	{
        ...
        public static List<Media> OldRetrieveAllMedia()
        {
        ...
        public static List<Media> OldRetrieveMediaByCategory(string category)
        {
            var mediaItems = new List<Media>();
        ...
        public static List<Media> OldRetrieveMediaByType(string type)
        {
            var mediaItems = new List<Media>();
