...
namespace SharedCode.DAL
{
	...
	public class RentalDal : IRentalDal
	{
        ...
        [Obsolete("Use the non static retrieve all rented items now")]
        public static List<RentalItem> OldRetrieveAllRentedItems()
        {
        ...
        [Obsolete("Use the non static retrieve selected rented items now")]
        public static List<RentalItem> OldRetrieveSelectRentedItems(string selectedStatus)
        {
            var rentedItems = new List<RentalItem>();
        ...
        [Obsolete("Use the non static update status now")]
        public static int OldUpdateStatus(int transactionId, string status, int employeeId)
        {
